...
::: {.columns}
::: {.column width="56%"}
- The sales process is about **auto-parts sales opportunities** with both potential leads and existing clients.
- Opportunities move back and forth across **Identified / Qualifying**, **Qualified / Validating**, and **Validated / Gaining Agreement**.
- Each opportunity ultimately ends in a **win or a loss**.
- Sales teams also assign an **estimated opportunity amount**, which appears to be updated as the deal evolves.
...
- For comparison, the **best-MAE** CV model was **`huber_robust_scaler`**, with **67.3k USD MAE** but a much lower **R² of 0.066**.
