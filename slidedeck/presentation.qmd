...
- Rank the pipeline using expected value (E[Amount] × P(Win)), not just propensity especially under limited sales capacity.
  ...
  - At top 25%, the comparison is 71.7% vs 66.8%, so deal-size information matters most when capacity is tight.
...
- **XGBoost** is strongest on aggregate, but the transformed linear variants remain competitive in smaller bins.
- The log-transform and power-transform variants reduce relative error in lower-value bands, while absolute error still rises materially for the largest opportunities.
:::
:::
...
**Expected-value ranking** (`predicted win probability × realized amount`)
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 10% | 2,275 | 306.1M | 66.9% | 44.2 pts | 13.3 pts | 27.1M | 40.6M | 54.1M |
| 25% | 5,686 | 616.4M | 54.6% | 31.9 pts | 9.6 pts | 39.3M | 58.9M | 78.6M |
| 50% | 11,373 | 1.129B | 39.7% | 17.0 pts | 5.1 pts | 38.3M | 57.4M | 76.6M |

**Probability-only ranking** (`y_proba`)

| Top slice kept | Opportunities | Forecasted amount inside slice | Segment win rate | Win-rate lift vs overall | Win-rate bonus (base) | Incremental revenue (conservative) | Incremental revenue (base) | Incremental revenue (aggressive) |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 10% | 2,275 | 186.5M | 80.0% | 57.2 pts | 17.2 pts | 21.3M | 32.0M | 42.7M |
| 25% | 5,686 | 462.0M | 61.4% | 38.7 pts | 11.6 pts | 35.7M | 53.6M | 71.5M |
| 50% | 11,373 | 967.5M | 41.6% | 18.9 pts | 5.7 pts | 36.5M | 54.7M | 73.0M |

- **Top 10%**: EV ranking leads by **+8.6M** incremental revenue at the base assumption (`λ = 0.3`), because the top slice concentrates much more forecasted value even though its win rate is lower than the probability-only slice.
- **Top 25%**: EV ranking still leads by **+5.3M** at the base assumption, showing that forecasted amount continues to matter once the slice widens.
- **Top 50%**: EV ranking leads by **+2.7M** at the base assumption; the two strategies become much closer once coverage broadens.
